...
public class TopologicalSortTests {
    ...
    public void TestTopSortAcyclicGraph6Vertices() {
        ...
        // Act
        Collection<String> topSorter = TopSortDFS.topSort(graph);
    ...
    public void TestTopSortAcyclicGraph5Vertices() {
        ...
        // Act
        Collection<String> topSorter = TopSortSourceRemoval.topSort(graph);
    ...
    public void TestTopSortGraph1Vertex() {
        ...
        // Act
        Collection<String> topSorted = TopSortDFS.topSort(graph);
    ...
    public void TestTopSortEmptyGraph() {
        ...
        // Act
        Collection<String> topSorted = TopSortSourceRemoval.topSort(graph);
